...
# Defining our Listings Model here..
# Listings and Realtors have a 1-m relations. 1 realtor/agent can post multiple home listings.
...
class Listing(models.Model):
    ...
    #Attributes...
    realtor = models.ForeignKey(Realtor, on_delete=models.DO_NOTHING)   # We are not doing the on_delete CASCADE becoz if the real estate agent leaves we would want our home to be still listed in our website.
    slug = models.CharField(max_length=200, unique=True)                # generating dynamic URL by passing the Title in the URL.
    ...
    photo_main = models.ImageField(upload_to='photos/%Y/%m/%d/')                #Per Realtor We allow only a max of 20 photos to be uploaded.
    ...
    # What is to be displayed in the default Django Admin page... 
    def __str__(self):
        return self.title
